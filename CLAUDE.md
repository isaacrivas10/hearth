...
- Never run `git commit` directly without user approval. Even after a
  commit pass is authorized, propose the groupings and messages first and
  wait for explicit approval before executing each commit.
